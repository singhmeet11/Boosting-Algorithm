...
void mem_data(Qureg qr, QuESTEnv env, int no_of_adress_qubits, int no_of_bits_in_memory_cell, vector<int> data){
...
void meas_QRAM(Qureg qr, QuESTEnv env, int no_of_adress_qubits, int no_of_bits_in_memory_cell, vector<int> data){
...
void QRAM(Qureg qr, QuESTEnv env, int no_of_adress_qubits, int no_of_bits_in_memory_cell, vector<int> data){
...
//    // inputting add
    ...
    mem_data(qr,env,no_of_adress_qubits, no_of_bits_in_memory_cell,data);
    //pauliX(qr, 1);
    ...
    meas_QRAM(qr, env, no_of_adress_qubits, no_of_bits_in_memory_cell,data);
...
//     prob_out_meas(4, qr, meas_qubits);
